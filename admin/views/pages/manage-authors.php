...
if(strlen($_SESSION['alogin']) == 0) {   
    ...
    if(isset($_GET['del'])) {
        ...
        header('location:dashboard.php?page=manageAuthor');
    }
?>
<!DOCTYPE html>
<html>
        ...
        <div class="container">
            <div class="row pad-botm">
                ...
                <?php if(isset($_SESSION['error']) && $_SESSION['error']!="") { ?>
                        <div class="col-md-6">
                            <div class="alert alert-danger" id="sm">
                                        ...
                                        ?>                                      
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                    ...
                                                    <a href="dashboard.php?page=manageAuthor&del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');">
