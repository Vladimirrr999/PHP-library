                                    ...
                                    <tbody>
                                        ...
                                        if($query->rowCount() > 0) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"><?php echo htmlentities($result->student_id_number);?></td>
                                                ...
                                                <td class="center">
                                                    <?php if($result->status==1) { ?>
                                                        <a href="dashboard.php?page=regStudents&inid=<?php echo htmlentities($result->id);?>" 
                                                        onclick="return confirm('Are you sure you want to block this student?');" >  
                                                        <button class="btn btn-danger"> Inactive</button>
                                                            <?php } else {?>
                                                                <a href="dashboard.php?page=regStudents&id=<?php echo htmlentities($result->id);?>" 
                                                                onclick="return confirm('Are you sure you want to active this student?');">
                                                                <button class="btn btn-primary"> Active</button> 
                                                            <?php } ?>
                                                            <a href="dashboard.php?page=details&stdid=<?php echo htmlentities($result->student_id_number);?>">
